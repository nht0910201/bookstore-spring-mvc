...
CREATE TABLE `cart`  (
  ...
  INDEX `cart2___fk`(`email`, `account_id`) USING BTREE,
  CONSTRAINT `cart1___fk` FOREIGN KEY (`pro_id`) REFERENCES `product` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `cart2___fk` FOREIGN KEY (`email`, `account_id`) REFERENCES `account` (`username`, `id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `order`  (
  ...
  INDEX `order1___fk`(`email`, `account_id`) USING BTREE,
  CONSTRAINT `order2___fk` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `order1___fk` FOREIGN KEY (`email`, `account_id`) REFERENCES `account` (`username`, `id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
