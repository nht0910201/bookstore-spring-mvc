...
public interface ProductRepository extends JpaRepository<Product,Integer> {
    ...
    @Query(value = "select distinct products.id,products.name,products.price,products.discount,products.category_id,products.description,products.author,products.publisher,products.publish_year,products.page_num,products.size,products.supplier,products.state from\n" +
